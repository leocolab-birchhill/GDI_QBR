...
export const en = {
  ...
  editor: {
    ...
    addItem: "Add item",
    emptyFollowUps: "No follow-ups yet — click below to add your first one.",
    emptyPriorities: "No priorities yet — click below to add your first one.",
    emptyMetrics: "No metrics yet — click below to add your first one.",
    emptyUpcoming: "No upcoming items yet — click below to add your first one.",
      ...
      steps: [
        {
          ...
          body: "Use the slide rail to jump between sections of the deck.",
        },
        {
          target: "add-button",
          title: "Add content",
          body: "Click the dashed Add buttons in each section to create priorities, metrics, initiatives, and follow-ups.",
        },
        {
          target: "chat",
          title: "Ask the assistant",
          body: "Describe changes in plain language and the assistant will propose edits to the deck.",
        },
        {
          target: "confirm",
          title: "Mark slides complete",
          body: "When a slide looks good, mark it complete to track progress through the review.",
        },
      ],
    },
    ...
    capabilities: {
      ...
      canItems: [
        ...
        "Add custom slides, delete custom slides, hide built-in slides, and hide dashboard sections",
