...
export const fr = {
  ...
  editor: {
    ...
    emptyFollowUps: "Aucun engagement — cliquez ci-dessous pour en ajouter un.",
    emptyPriorities: "Aucune priorité — cliquez ci-dessous pour en ajouter une.",
    emptyMetrics: "Aucun indicateur — cliquez ci-dessous pour en ajouter un.",
    emptyUpcoming: "Aucun élément à venir — cliquez ci-dessous pour en ajouter un.",
    ...
    tour: {
      ...
      steps: [
        {
          target: "slide-nav",
          title: "Naviguer les diapositives",
          body: "Utilisez la barre de diapositives pour passer d'une section à l'autre de la présentation.",
        },
        {
          target: "add-button",
          title: "Ajouter du contenu",
          body: "Cliquez sur les boutons Ajouter en pointillé dans chaque section pour créer des priorités, indicateurs, initiatives et engagements.",
        },
        {
          target: "chat",
          title: "Demander à l'assistant",
          body: "Décrivez les changements en langage naturel et l'assistant proposera des modifications à la présentation.",
        },
        {
          target: "confirm",
          title: "Marquer les diapositives",
          body: "Quand une diapositive est prête, marquez-la comme complète pour suivre l'avancement de la revue.",
        },
      ],
    },
    ...
    capabilities: {
      ...
      canItems: [
        ...
        "Ajouter des diapositives personnalisées, supprimer les personnalisées, masquer les intégrées et masquer des sections du tableau de bord",
      ...
      cantItems: [
        ...
        "Créer des valeurs d’indicateurs — entrez une valeur réelle ou laissez « À confirmer »",
      ],
    },
  },
  create: {
